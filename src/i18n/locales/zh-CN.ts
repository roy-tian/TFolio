...
const zhCN = {
  ...
  mergeWizard: {
    ...
    stepPageNumbers: "页码",
    stepWatermark: "水印",
    filesDescription: "PDF 与图片会按放下的顺序加入向导的列表。",
    addFiles: "添加文件",
    sourceFilter: "PDF 与图片",
    empty: "还没有文件。至少添加两个 PDF 才能合并；图片会各自转换成一页。",
    emptyCopies: "还没有文件。添加要处理的 PDF；图片会各自转换成一页。",
    imageSource: "图片",
    ...
    smartPaddingUnavailable: "只有把文件合并成一个文档时，空白页才有意义。",
    normalizeA4: "统一页面尺寸为 A4",
    normalizeA4Hint:
      "小于 A4 的页面按原大小居中放置，大于 A4 的按原比例缩小至页内；图片一律铺满整页。只有页面内容会被搬过去，批注和链接不会保留。",
    normalizeA4Warning:
      "统一为 A4 只搬运页面内容：源文件页面上的批注和链接不会保留。",
    exportMode: "导出方式",
    exportOnePdf: "合并为一个 PDF 文件",
    exportPagePngZip: "每页一张 PNG 图片，返回压缩包",
    exportWatermarkOnlyZip: "不合并仅加水印，返回压缩包",
    exportWatermarkOnlyHint:
      "文件不会合并：每个文件单独加水印后写入压缩包，因此没有可添加的页码。",
    bookmarksNone: "无书签",
    ...
    writingArchive: "正在写入压缩包…",
    progressHint: "较大的文件可能需要一些时间。",
    stop: "停止",
    stopping: "正在停止…",
    cancel: "取消",
    mergedName: "合并文档.pdf",
    pagesArchiveName: "页面图片.zip",
    copiesArchiveName: "水印文档.zip",
    copiesArchiveNamePlain: "文档副本.zip",
    archiveFilter: "ZIP 压缩包",
    errorMerge: "无法合并这些文件。",

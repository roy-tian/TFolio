...
const zhCN = {
  ...
  tabs: {
    ...
    saveBeforeClose: "保存",
    unsavedQuitDescription: "已打开文档尚有未保存的修改，退出将丢弃这些修改。",
    unsavedQuitElsewhereDescription:
      "其他窗口尚有未保存的修改，或未能应答，退出将丢弃这些修改。",
    unsavedQuitHereAndElsewhereDescription:
      "此窗口的文档尚有未保存的修改，其他窗口也有或未能应答，退出将全部丢弃。",
    discardAndQuit: "丢弃并退出",
    busyTitle: "停止进行中的操作?",
    busyTabDescription: "此文档仍有编辑或导出在进行，关闭标签页将停止它。",
    busyAllDescription: "已打开文档仍有编辑或导出在进行，关闭将停止它。",
    busyQuitDescription: "已打开文档仍有编辑或导出在进行，退出将停止它。",
    stopAndClose: "停止并关闭",
    stopAndQuit: "停止并退出",
  ...
  compressExport: {
    menuLabel: "减小文件大小…",
    title: "减小文件大小",
    description: "自动压缩文件结构与图片，文字保持可选可搜。",
    imageQuality: "图片分辨率",
    ...
    filter: "PDF 文档",
    suffix: "已压缩",
    estimate: "预计大小：{{size}}（缩小 {{percent}}%）",
    estimateNoSaving: "预计大小：{{size}}（不小于当前文件）",
    estimating: "正在估算大小…",
  ...
  viewer: {
    ...
    wordConverting: "正在将 {{name}} 转换为 PDF…",
    wordConvertStop: "停止",
    wordConvertStopping: "正在停止…",

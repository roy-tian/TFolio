const en = {
  ...
  archiveExport: {
    title: "Export",
    description: "Export the current document to a ZIP archive.",
    format: "Export format",
    jpg: "One JPG image per page",
    png: "One PNG image per page",
    bookmarks: "Split PDF by top-level bookmarks",
    imagesHint: "300 dpi, named in page order. Oversized pages are scaled to fit.",
